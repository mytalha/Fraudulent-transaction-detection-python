...
# Calculate the ratio of fraudulent transactions to non-fraudulent transactions
fraud_ratio = data['is_fraud'].value_counts(normalize=True)
labels = ['Non-Fraudulent', 'Fraudulent']

# Create a pie chart to visualize the ratio
plt.figure(figsize=(8, 6))
plt.pie(fraud_ratio, labels=labels, autopct='%1.1f%%', startangle=90)
plt.title('Fraudulent Transactions Ratio')
plt.show()

# Create a count plot to visualize the distribution of fraudulent transactions
plt.figure(figsize=(8, 6))
